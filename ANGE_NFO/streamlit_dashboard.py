...
# Tab 2: Tactical Analysis
    ...
    with col1:
        ...
        st.markdown("""
        <div style="background: linear-gradient(to bottom, #dc2626, #b91c1c); height: 300px; border-radius: 10px; position: relative; color: white; display: flex; align-items: center; justify-content: center;">
            <div style="text-align: center;">
    ...
    # Create proper grid layout for players
    for i in range(0, len(player_df), 2):
        col1, col2 = st.columns(2)
        
        # First player
        if i < len(player_df):
            player = player_df.iloc[i]
            team_color = "#f0fdf4" if player['team'] == 'Forest' else "#fef2f2"
            text_color = "#15803d" if player['team'] == 'Forest' else "#dc2626"
            rating_color = "#dcfce7" if player['performance_rating'] >= 8 else "#fef3c7" if player['performance_rating'] >= 7 else "#f3f4f6"
            rating_text_color = "#16a34a" if player['performance_rating'] >= 8 else "#d97706" if player['performance_rating'] >= 7 else "#4b5563"
            ...
            with col1:
                ...
                <div style="background: {team_color}; padding: 1rem; border-radius: 8px; margin-bottom: 1rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                        ...
                        <span style="background: {rating_color}; color: {rating_text_color}; padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold;">
...
# Tab 3: Live Timeline
    ...
    <div style="margin-top: 2rem;">
        <div style="display: flex; justify-content: space-between; font-size: 0.9rem; color: #6b7280; margin-bottom: 0.5rem;">
