...
try:
    full_data = [json.loads(line) for line in json_string.strip().split('\n') if line]
...
if not all([match_info, ange_comparison_data, europa_data, match_stats, innovative_metrics_data, flank_transition_data, player_stats_match, player_highlights]):
...
timeline_data = [
    ...
    {'minute': 2, 'Burnley': xg_timeline_data['xg_timeline'][0]['Burnley'], 'Forest': xg_timeline_data['xg_timeline'][0]['Forest'], 'event': 'Williams Goal', 
     'description': 'Early goal from Neco Williams, build-up through Luiz retention',
     'ppda_forest': ppda_segments_data['ppda_segments'][0]['Forest'], 'ppda_burnley': ppda_segments_data['ppda_segments'][0]['Burnley'], 
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['first_half'], 'possession_burnley': match_info_full['possession']['Burnley']['first_half']},
    {'minute': 15, 'Burnley': xg_timeline_data['xg_timeline'][1]['Burnley'], 'Forest': xg_timeline_data['xg_timeline'][1]['Forest'], 'event': 'Forest Press Peak', 
     'description': 'Forest PPDA at 8.5, Burnley struggling with high press',
     'ppda_forest': ppda_segments_data['ppda_segments'][0]['Forest'], 'ppda_burnley': ppda_segments_data['ppda_segments'][0]['Burnley'], 
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['first_half'], 'possession_burnley': match_info_full['possession']['Burnley']['first_half']},
    {'minute': 20, 'Burnley': xg_timeline_data['xg_timeline'][1]['Burnley'], 'Forest': xg_timeline_data['xg_timeline'][1]['Forest'], 'event': 'Anthony Goal', 
     ...
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['first_half'], 'possession_burnley': match_info_full['possession']['Burnley']['first_half']},
    {'minute': 30, 'Burnley': xg_timeline_data['xg_timeline'][2]['Burnley'], 'Forest': xg_timeline_data['xg_timeline'][2]['Forest'], 'event': 'Tactical Networks', 
     'description': 'Forest triangulate left side (Zinchenko-Ndoye-Luiz), Burnley overload right',
     'ppda_forest': ppda_segments_data['ppda_segments'][1]['Forest'], 'ppda_burnley': ppda_segments_data['ppda_segments'][1]['Burnley'], 
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['first_half'], 'possession_burnley': match_info_full['possession']['Burnley']['first_half']},
    {'minute': 45, 'Burnley': xg_timeline_data['xg_timeline'][2]['Burnley'], 'Forest': xg_timeline_data['xg_timeline'][2]['Forest'], 'event': 'Half-time', 
     ...
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['first_half'], 'possession_burnley': match_info_full['possession']['Burnley']['first_half']},
    {'minute': 54, 'Burnley': xg_timeline_data['xg_timeline'][2]['Burnley'] + 0.1, 'Forest': xg_timeline_data['xg_timeline'][2]['Forest'] + 0.15, 'event': 'Hudson-Odoi Introduction', 
    ...
    {'minute': 60, 'Burnley': xg_timeline_data['xg_timeline'][2]['Burnley'] + 0.15, 'Forest': xg_timeline_data['xg_timeline'][2]['Forest'] + 0.22, 'event': 'Pressing Shift', 
     'description': 'Burnley switch to higher press, Forest press drops',
     'ppda_forest': ppda_segments_data['ppda_segments'][3]['Forest'], 'ppda_burnley': ppda_segments_data['ppda_segments'][3]['Burnley'], 
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['second_half'], 'possession_burnley': match_info_full['possession']['Burnley']['second_half']},
    {'minute': 75, 'Burnley': xg_timeline_data['xg_timeline'][2]['Burnley'] + 0.38, 'Forest': xg_timeline_data['xg_timeline'][2]['Forest'] + 0.69, 'event': 'Laurent On', 
     ...
     'possession_forest': match_info_full['possession']['Nottingham_Forest']['second_half'], 'possession_burnley': match_info_full['possession']['Burnley']['second_half']},
    {'minute': 88, 'Burnley': xg_timeline_data['xg_timeline'][3]['Burnley'] - 0.06, 'Forest': xg_timeline_data['xg_timeline'][3]['Forest'] - 0.06, 'event': 'Final Forest Push', 
...
player_performance = [
    {'name': 'Zinchenko', 'team': 'Forest', 'progressive_passes': player_highlights_data['player_highlights']['Nottingham_Forest']['Zinchenko']['progressive_passes'], 'final_third_entries': player_highlights_data['player_highlights']['Nottingham_Forest']['Zinchenko']['final_third_entries'],
     'pass_accuracy': player_highlights_data['player_highlights']['Nottingham_Forest']['Zinchenko']['pass_accuracy'], 'key_moment': '19\' Defensive error leading to goal',
     'tactical_role': 'Progressive left-back, high positioning', 'performance_rating': 7.2},
    {'name': 'Gibbs-White', 'team': 'Forest', 'shot_creating_actions': player_highlights_data['player_highlights']['Nottingham_Forest']['Gibbs_White']['shot_creating_actions'], 'recoveries': player_highlights_data['player_highlights']['Nottingham_Forest']['Gibbs_White']['recoveries'], 'dribbles': 3,
     'key_moment': 'Dropping deep to link play', 'tactical_role': 'Fluid #10, creating connections', 'performance_rating': 7.8},
    {'name': 'Chris Wood', 'team': 'Forest', 'box_touches': player_highlights_data['player_highlights']['Nottingham_Forest']['Chris_Wood']['box_touches'], 'aerial_duels_won': player_highlights_data['player_highlights']['Nottingham_Forest']['Chris_Wood']['aerial_duels_won'], 'shots': player_highlights_data['player_highlights']['Nottingham_Forest']['Chris_Wood']['shots'],
     'key_moment': 'Physical presence in final third', 'tactical_role': 'Target man with link-up evolution', 'performance_rating': 7.1},
    {'name': 'Josh Cullen', 'team': 'Burnley', 'passes': player_highlights_data['player_highlights']['Burnley']['Cullen']['passes_completed'], 'pass_accuracy': 87, 'recoveries': player_highlights_data['player_highlights']['Burnley']['Cullen']['recoveries'],
     'key_moment': 'Controlling tempo from deep', 'tactical_role': 'Deep-lying playmaker in pivot', 'performance_rating': 8.1},
    {'name': 'Jaidon Anthony', 'team': 'Burnley', 'goals': 1, 'shots': player_highlights_data['player_highlights']['Burnley']['Anthony']['shots'], 'dribbles': 3,
...
if tab_selection == "Match Overview":
    ...
    with col4:
        ...
        <div class="metric-card">
            <h3>Forest PPDA</h3>
            <div style="font-size: 2rem; font-weight: bold;">{match_info_full['ppda']['Nottingham_Forest']['interval_1_15']}</div>
    ...
    with col1:
        ...
        stats_data = {
            ...
            'Burnley': [match_stats_full['stat_totals']['shots']['Burnley'], match_stats_full['stat_totals']['shots_on_target']['Burnley'], match_stats_full['stat_totals']['big_chances']['Burnley'], match_stats_full['stat_totals']['corners']['Burnley'], match_stats_full['stat_totals']['fouls_committed']['Burnley']],
            'Forest': [match_stats_full['stat_totals']['shots']['Forest'], match_stats_full['stat_totals']['shots_on_target']['Forest'], match_stats_full['stat_totals']['big_chances']['Forest'], match_stats_full['stat_totals']['corners']['Forest'], match_stats_full['stat_totals']['fouls_committed']['Forest']]
        }
    ...
    with col2:
        ...
        conversion_data = pd.DataFrame({
            'Team': ['Burnley', 'Forest'],
            'Shots': [match_stats_full['stat_totals']['shots']['Burnley'], match_stats_full['stat_totals']['shots']['Forest']],
            'On Target': [match_stats_full['stat_totals']['shots_on_target']['Burnley'], match_stats_full['stat_totals']['shots_on_target']['Forest']],
...
# Tab 5: Advanced Metrics
    ...
    # Get advanced metrics from JSON
    transition_exposure_data = next(item for item in full_data if "transition_exposure" in item and "avg_gap_m" in item['transition_exposure']['Forest'])
    build_up_chain_volume_data = next(item for item in full_data if "build_up_chain_volume" in item)
    sustained_threat_index_data = next(item for item in full_data if "innovative_metrics" in item)
    flank_isolation_data = next(item for item in full_data if "flank_isolation_metric" in item and "cross_effectiveness_index" in item)

    metrics = [
        {"title": "Transition Exposure", "value": f"{transition_exposure_data['transition_exposure']['Forest']['avg_gap_m']}m", "subtitle": "Forest avg gap", "color": "#cc1c1c"},
        {"title": "Build-Up Chains 10+", "value": f"{build_up_chain_volume_data['Build-Up Chain Volume']['Ange Forest']}", "subtitle": f"Forest vs {build_up_chain_volume_data['Build-Up Chain Volume']['Nuno Forest']} Burnley", "color": "#cc1c1c"},
        {"title": "Sustained Threat", "value": f"{sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Forest']}", "subtitle": f"Forest vs {sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Nuno Forest']} Burnley", "color": "#cc1c1c"},
        {"title": "Flank Isolation", "value": f"{flank_isolation_data['flank_isolation_metric']['Burnley']['total_wide_1v1s'] + flank_isolation_data['flank_isolation_metric']['Forest']['total_wide_1v1s']}", "subtitle": "Total 1v1 battles", "color": "#cc1c1c"}
    ]
    ...
    with col1:
        transition_data = pd.DataFrame({
            'Team': ['Forest', 'Burnley'],
            'Avg Gap (m)': [transition_exposure_data['transition_exposure']['Forest']['avg_gap_m'], transition_exposure_data['transition_exposure']['Burnley']['avg_gap_m']],
            'Max Gap (m)': [transition_exposure_data['transition_exposure']['Forest']['max_gap_m'], transition_exposure_data['transition_exposure']['Burnley']['max_gap_m']],
    ...
    with col2:
        ...
        <div class="insight-box">
            ...
            <div style="font-size: 0.9rem; color: #e0e0e0;">
                <div>Average Gap: {transition_exposure_data['transition_exposure']['Forest']['avg_gap_m']}m (vs {transition_exposure_data['transition_exposure']['Burnley']['avg_gap_m']}m Burnley)</div>
                <div>Max Exposure: {transition_exposure_data['transition_exposure']['Forest']['max_gap_m']}m (vs {transition_exposure_data['transition_exposure']['Burnley']['max_gap_m']}m Burnley)</div>
        ...
        <div class="stat-container">
            ...
            <div style="color: #e0e0e0;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                    ...
                    <span style="font-weight: bold;">{build_up_chain_volume_data['Build-Up Chain Volume']['Ange Forest']}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                    <span>Burnley 10+ Pass Chains:</span>
                    <span style="font-weight: bold;">{build_up_chain_volume_data['Build-Up Chain Volume']['Nuno Forest']}</span>
                </div>
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                    <span>Forest Avg Length:</span>
                    <span style="font-weight: bold;">{sustained_threat_index_data['innovative_metrics']['Average Build-up Length']} passes</span>
                </div>
    ...
    with col2:
        ...
        <div class="stat-container">
            ...
            <div style="text-align: center; margin-bottom: 1rem;">
                <div style="font-size: 2.5rem; font-weight: bold; color: #cc1c1c;">{sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Forest']}</div>
                <div style="font-size: 0.9rem; color: #e0e0e0;">Forest STI</div>
            </div>
            <div style="text-align: center;">
                <div style="font-size: 1.5rem; font-weight: bold; color: #ef4444;">{sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Nuno Forest']}</div>
        ...
        <div class="stat-container">
            ...
            <div style="font-size: 0.9rem; color: #e0e0e0;">
                <div style="margin-bottom: 0.5rem;">
                    <strong>Ange Spurs STI:</strong> {sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Ange Spurs']}
                </div>
                <div style="margin-bottom: 0.5rem;">
                    <strong>Premier League Avg:</strong> 0.18
                </div>
                <div style="margin-bottom: 0.5rem;">
                    <strong>Nuno Forest:</strong> {sustained_threat_index_data['innovative_metrics']['Sustained Threat Index']['Nuno Forest']}
                </div>
            </div>
            <p style="font-size: 0.8rem; color: #e0e0e0; margin-top: 0.75rem; font-style: italic;">
    ...
    effectiveness_data = [
        {"team": "Forest", "rate": f"{cross_effectiveness_data['cross_effectiveness']['Forest']['cross_to_shot_pct']*100:.0f}%", "total": cross_effectiveness_data['cross_effectiveness']['Forest']['total_crosses'], "successful": cross_effectiveness_data['cross_effectiveness']['Forest']['successful'], "hudson_rate": "50%", "color": "#cc1c1c"},
        {"team": "Burnley", "rate": f"{cross_effectiveness_data['cross_effectiveness']['Burnley']['cross_to_shot_pct']*100:.0f}%", "total": cross_effectiveness_data['cross_effectiveness']['Burnley']['total_crosses'], "successful": cross_effectiveness_data['cross_effectiveness']['Burnley']['successful'], "hartman": "4 crosses", "color": "#ef4444"}
    ]
